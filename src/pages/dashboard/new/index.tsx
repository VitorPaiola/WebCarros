...
const schema = z.object({
    ...
    // Indica o início da string (^) | Onde colocamos nossa operação (()) | É um caracter que indica um digito entre 0 e 9 (\d)
    // Nos diz que vamos colocar um valor entre 0 a 9 e pode ser de 11 ou 12 digitos (\d{11,12}) 
            ...
            <div className="w-full bg-white p-3 rounded-lg flex flex-col sm:flex-row items-center gap-2">
                ...
                {carImages.map(item => (
                    <div key={item.uid} className="w-full h-32 flex items-center justify-center relative">
                        ...
                        <img className="rounded-lg w-full h-32 object-cover" src={item.previewUrl} alt="Foto do carro" />
                    </div>
                ))}
            </div>
